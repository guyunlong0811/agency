...
<div class="page-content" style="min-height:648px !important">
    ...
    <div class="container-fluid">
        ...
        <?php if(empty($vList)): ?><div class="alert alert-danger">
...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <a href="/agency/index.php?s=/Home/Admin/add&p=<?php echo ($pg); ?>" style="color:whitesmoke;"><?php echo (L("admin_add")); ?></a>
                    </div>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
            ...
            <tbody>
            <?php if(is_array($vList)): $i = 0; $__LIST__ = $vList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($value["id"]); ?></td>
                    <td><?php echo ($value["username"]); ?></td>
                    <td><?php echo ($value["nickname"]); ?></td>
                    <td><a href="/agency/index.php?s=/Home/Admin/status&id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo ($value["status"]); ?></a></td>
                    <td><a href="/agency/index.php?s=/Home/Admin/edit&id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("edit")); ?></a></td>
                    <td><a href="/agency/index.php?s=/Home/Admin/permission&id=<?php echo ($value["id"]); ?>&p=<?php echo ($pg); ?>"><?php echo (L("permission")); ?></a></td>
