...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat blue">
            ...
            <a class="more" href="/agency/index.php?s=/Home/DataOnlineCount">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat green">
            ...
            <a class="more" href="/agency/index.php?s=/Home/DataUsersRetention">
                <?php echo (L("more")); ?> <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat purple">
            ...
            <a class="more" href="/agency/index.php?s=/Home/DataActiveUsers">
                <?php echo (L("more")); ?> <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat yellow">
            ...
            <a class="more" href="/agency/index.php?s=/Home/DataConsume">
                <?php echo (L("more")); ?> <i class="m-icon-swapright m-icon-white"></i>
            </a>
        </div>
    </div>
    ...
    <div class="scroller" style="height: 280px;" data-always-visible="1" data-rail-visible="0">
        <table class="table table-striped table-bordered table-hover table-full-width">
            ...
            <?php if(is_array($value)): foreach($value as $k=>$val): ?><tr>
                    ...
                    <td><a href="/agency/index.php?s=/Home/UserInfo&server_id=<?php echo ($val["sid"]); ?>&team_id=<?php echo ($val["tid"]); ?>"><?php echo ($val["tid"]); ?></a></td>
                    <td><?php echo (L("$val[type]")); ?></td>
                    <?php if(($key) == "partner_soul"): ?><td><?php echo ($val["params"]); ?></td><?php endif; ?>
                    <td><?php echo ($val["value"]); ?></td>
                    <td><a href="/agency/index.php?s=/Home/Index/status&id=<?php echo ($val["id"]); ?>"><?php echo (L("solve")); ?></a></td>
